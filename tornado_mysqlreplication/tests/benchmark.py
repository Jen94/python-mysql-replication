...
conn = tornado_mysql.connect(**database)

execute(conn, "DROP DATABASE IF EXISTS tornado_mysqlreplication_test")
execute(conn, "CREATE DATABASE tornado_mysqlreplication_test")
conn = tornado_mysql.connect(**database)
