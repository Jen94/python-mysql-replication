...
from tornado_mysqlreplication.tests import base
from tornado_mysqlreplication import BinLogStreamReader
from tornado_mysqlreplication.gtid import GtidSet
from tornado_mysqlreplication.event import *
from tornado_mysqlreplication.exceptions import TableMetadataUnavailableError
from tornado_mysqlreplication.constants.BINLOG import *
...
class TestBasicBinLogStreamReader(base.tornado_mysqlreplicationTestCase):
    ...
    def test_write_row_event(self):
        ...
        self.assertEqual(event.schema, "tornado_mysqlreplication_test")
...
class TestMultipleRowBinLogStreamReader(base.tornado_mysqlreplicationTestCase):
    def ignoredEvents(self):
        return [GtidEvent]
...
class TestCTLConnectionSettings(base.tornado_mysqlreplicationTestCase):
    ...
    def setUp(self):
        ...
        self.ctl_conn_control.cursor().execute("DROP DATABASE IF EXISTS tornado_mysqlreplication_test")
        self.ctl_conn_control.cursor().execute("CREATE DATABASE tornado_mysqlreplication_test")
...
class TestGtidBinLogStreamReader(base.tornado_mysqlreplicationTestCase):
    def setUp(self):
