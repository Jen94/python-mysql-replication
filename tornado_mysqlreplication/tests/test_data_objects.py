...
from tornado_mysqlreplication.column import Column
from tornado_mysqlreplication.table import Table
...
class TestDataObjects(base.tornado_mysqlreplicationTestCase):
