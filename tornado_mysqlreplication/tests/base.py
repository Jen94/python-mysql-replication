...
class tornado_mysqlreplicationTestCase(base):
    ...
    def setUp(self):
        ...
        self.database = {
            ...
            "use_unicode": True,
            "charset": "utf8",
            "db": "tornado_mysqlreplication_test"
        }
        ...
        self.execute("DROP DATABASE IF EXISTS tornado_mysqlreplication_test")
        self.execute("CREATE DATABASE tornado_mysqlreplication_test")
        db = copy.copy(self.database)
        self.connect_conn_control(db)
        self.stream = None
        self.resetBinLog()
    ...
    def connect_conn_control(self, db):
        ...
        self.conn_control = tornado_mysql.connect(**db)
